    ...
    mkIf cfg.enable
    {
      ...
      services.home-assistant = {
        ...
        config = {
          ...
          default_config = {};
          # TODO: check if this work and does not make ha crash when starting
          # add scenes-nix.yaml and automations-nix.yaml to /var/lib/hass using nix
          # Will need to generate scenes-nix.yaml from scenes.yaml generated by home-assistant-frontend and place them in the configuration to leep it reporduciable
